...
const DEX = {
  ...
  "Beautifly":267,"Cascoon":268,"Dustox":269,"Lotad":270,"Lombre":271,"Ludicolo":272,
  "Seedot":273,"Nuzleaf":274,"Shiftry":275,"Taillow":276,"Swellow":277,"Wingull":278,
  "Pelipper":279,"Ralts":280,"Kirlia":281,"Gardevoir":282,"Surskit":283,"Masquerain":284,
  "Shroomish":285,"Breloom":286,"Slakoth":287,"Vigoroth":288,"Slaking":289,"Nincada":290,
  "Ninjask":291,"Shedinja":292,"Whismur":293,"Loudred":294,"Exploud":295,"Makuhita":296,
  "Hariyama":297,"Azurill":298,"Nosepass":299,"Skitty":300,"Delcatty":301,"Sableye":302,
  ...
  "Roselia":315,"Gulpin":316,"Swalot":317,"Carvanha":318,"Sharpedo":319,"Wailmer":320,
  "Wailord":321,"Numel":322,"Camerupt":323,"Torkoal":324,"Spoink":325,"Grumpig":326,
  "Spinda":327,"Trapinch":328,"Vibrava":329,"Flygon":330,"Cacnea":331,"Cacturne":332,
  "Swablu":333,"Altaria":334,"Zangoose":335,"Seviper":336,"Lunatone":337,"Solrock":338,
  "Barboach":339,"Whiscash":340,"Corphish":341,"Crawdaunt":342,"Baltoy":343,"Claydol":344,
  "Lileep":345,"Cradily":346,"Anorith":347,"Armaldo":348,"Feebas":349,"Milotic":350,
  "Castform":351,"Kecleon":352,"Shuppet":353,"Banette":354,"Duskull":355,"Dusclops":356,
  "Tropius":357,"Chimecho":358,"Absol":359,"Wynaut":360,"Snorunt":361,"Glalie":362,
  "Spheal":363,"Sealeo":364,"Walrein":365,"Clamperl":366,"Huntail":367,"Gorebyss":368,
  "Relicanth":369,"Luvdisc":370,"Bagon":371,"Shelgon":372,"Salamence":373,"Beldum":374,
  "Metang":375,"Metagross":376,"Regirock":377,"Regice":378,"Registeel":379,"Latias":380,
  "Latios":381,"Kyogre":382,"Groudon":383,"Rayquaza":384,"Jirachi":385,"Deoxys":386,
  ...
  "Bastiodon":411,"Burmy":412,"Wormadam":413,"Wormadam-Sandy":413,"Wormadam-Trash":413,
  "Mothim":414,"Combee":415,"Vespiquen":416,"Pachirisu":417,"Buizel":418,"Floatzel":419,
  "Cherubi":420,"Cherrim":421,"Shellos":422,"Gastrodon":423,"Ambipom":424,"Drifloon":425,
  "Drifblim":426,"Buneary":427,"Lopunny":428,"Mismagius":429,"Honchkrow":430,
  "Glameow":431,"Purugly":432,"Chingling":433,"Stunky":434,"Skuntank":435,"Bronzor":436,
  "Bronzong":437,"Bonsly":438,"Mime Jr.":439,"Happiny":440,"Chatot":441,"Spiritomb":442,
  ...
  "Yanmega":469,"Leafeon":470,"Glaceon":471,"Gliscor":472,"Mamoswine":473,"Porygon-Z":474,
  "Gallade":475,"Probopass":476,"Dusknoir":477,"Froslass":478,"Rotom":479,
  "Rotom-Heat":479,"Rotom-Wash":479,"Rotom-Frost":479,"Rotom-Fan":479,"Rotom-Mow":479,
  "Uxie":480,"Mesprit":481,"Azelf":482,"Dialga":483,"Palkia":484,"Heatran":485,
  "Regigigas":486,"Giratina":487,"Giratina-Origin":487,"Cresselia":488,"Phione":489,
  "Manaphy":490,"Darkrai":491,"Shaymin":492,"Shaymin-Sky":492,
  "Arceus":493,
};
...
// Handle all arceus forms (lowercase in data, any type suffix)
for (const key of Object.keys(DEX)) {
  DEX[key.toLowerCase()] = DEX[key];
}
// arceus-<type> forms not listed individually; also handle Farfetch'd apostrophe variants
const pokeRaw = JSON.parse(readFileSync(POKE_CLIENT, "utf8"));
for (const p of pokeRaw) {
  if (p.name.toLowerCase().startsWith("arceus-")) DEX[p.name] = 493;
  // U+2019 right single quotation mark variant used in data
  if (/^Farfetch/i.test(p.name)) DEX[p.name] = 83;
}
...
let missing = [];
pokemons.forEach((p) => {
  const num = DEX[p.name] ?? DEX[p.name.toLowerCase()];
  if (num) {
    p.dexNum = num;
  } else {
    missing.push(p.name);
...
writeFileSync(POKE_PATH,   json);
writeFileSync(POKE_CLIENT, json);

if (missing.length) console.warn("⚠ No dexNum found for:", missing.join(", "));
console.log(`Done — dexNum added to ${pokemons.length} Pokémon.`);
