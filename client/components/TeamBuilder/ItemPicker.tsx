    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative" ref={ref}>
        <button
          type="button"
          className={cn(
            "flex items-center gap-2.5 w-full text-left bg-input-bg border rounded-[9px] px-3 py-2.25 transition-all duration-140",
        ...
        >
          ...
          <svg
            ...
            className={cn("text-faint shrink-0 transition-transform duration-150", open && "rotate-180")}
          >
            <path d="m6 9 6 6 6-6" />
          </svg>
        </button>
